...
if __name__ == "__main__":
    ...
    try:
        ...
        os.system("g++ -std=c++11 -o " + zol_exec_path + "runRBH src/zol/orthologs/runRBH.cpp")
        os.system("g++ -std=c++11 -o " + zol_exec_path + "splitDiamondResults src/zol/orthologs/splitDiamondResults.cpp")
        os.system("g++ -std=c++11 -o " + zol_exec_path + "splitDiamondResultsForFai src/zol/splitDiamondResultsForFai.cpp")
