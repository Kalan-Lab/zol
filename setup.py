...
# set up STAG by Emms and Kelly 2018
os.chdir('external_tools/')
...
if not os.path.isfile('Treemmer_v0.3.py'):
      os.system("axel https://raw.githubusercontent.com/fmenardo/Treemmer/master/Treemmer_v0.3.py")
