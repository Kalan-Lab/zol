...
BGC score (GECCO weights)\tA score from ~ -7 (less BGC like) to ~13 (more BGC like) - based on maximum weight of Pfam domains in GECCO BGC detection (Carroll, Larralde, Fleck, et al. 2021). A histogram of values can be found on the wiki documentation link above.\tGECCO paper: https://www.biorxiv.org/content/10.1101/2021.05.03.442509v1.full
