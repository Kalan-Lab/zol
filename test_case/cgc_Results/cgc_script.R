...
dat <- read.table("/Users/raufs/Coding/zol/develop_v1.6.0/commit/zol/test_case/cgc_Results/Plot_Input.txt", header = T, sep = "\t")
...
pdf("/Users/raufs/Coding/zol/develop_v1.6.0/commit/zol/test_case/cgc_Results/cgc_plot.pdf", height = 7, width = 7)
