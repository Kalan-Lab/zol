library(ggplot2)
library(gridExtra)
info.file <- "/Users/raufs/Coding/zol/develop_v1.6.10/zol/test_case/fai_Results_3/Plotting_Files/Tiny_AAI_Plot_Data.txt"
pdf_file <- "/Users/raufs/Coding/zol/develop_v1.6.10/zol/test_case/fai_Results_3/Final_Results/Candidate_Homologous_Gene_Clusters.Tiny_AAI_Plot.pdf"
