...
medlen.data_file <- "/Users/raufs/Coding/zol/develop_v1.6.0/commit/zol/test_case/zol_Results/Plot_Workspace/OG_Median_Length_Info.txt"
heatmap.data_file <- "/Users/raufs/Coding/zol/develop_v1.6.0/commit/zol/test_case/zol_Results/Plot_Workspace/OG_Heatmap_Info.txt"
pdf_file <- "/Users/raufs/Coding/zol/develop_v1.6.0/commit/zol/test_case/zol_Results/Final_Results/Heatmap_Overview.pdf"
height <- as.numeric(7)
width <- as.numeric(14)
